...
export { JSObject, JSClass, JSSystemGetClasses, JSSystemGetAllClasses, JSSystemTryBecomeClass, Random_Serial_BigInt, Throwable, JSError, JSException, JSSystemGetClass, ClassNotFoundError, IllegalArgumentException, UnsupportedOperationException, CloneNotSupportedException, ObjectSerializableFailedException, ObjectDeserializableFailedException, };
export type { Random_Serial_BigInt_Interface, INewEmptyObject, ICloneable, Static_Implements, ISerializable, IDeserializable, };
